...
import id.imam.adminkkp.adapter.AdapterSemuaUser;
...
public class DataSemuaUser extends AppCompatActivity {
    Display mDisplay;
    String imagesUri;
    String path;
    Bitmap bitmap;
    ...
    String file_name = "Bukti semua user";
    File myPath;

    FirebaseFirestore firebaseFirestore;
    RecyclerView recyclerViewuser;
    AdapterSemuaUser adapter;
    Button btncetakkk;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_data_semua_user);
        firebaseFirestore = FirebaseFirestore.getInstance();
        recyclerViewuser = findViewById(R.id.recycuser);
        btncetakkk = findViewById(R.id.cetaksemuauser);
        ...
        btncetakkk.setOnClickListener(new View.OnClickListener() {
            @RequiresApi(api = Build.VERSION_CODES.KITKAT)
            @Override
            public void onClick(View view) {

                btncetakkk.setVisibility(View.GONE);

                takeS();
                btncetakkk.setVisibility(View.VISIBLE);
        ...
        Query query2 = firebaseFirestore.collection("user");
        FirestoreRecyclerOptions<ModelSemuaUser> options = new FirestoreRecyclerOptions.Builder<ModelSemuaUser>()
                .setQuery(query2,ModelSemuaUser.class)
                .build();
        adapter = new AdapterSemuaUser(options);
    ...
    private void takeS() {
        ...
        View u = findViewById(R.id.nesteduser);

        NestedScrollView z = findViewById(R.id.nesteduser);
